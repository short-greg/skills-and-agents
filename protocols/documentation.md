...
For creating CLAUDE.md, AGENTS.md, or similar project-level documentation that AI coding agents read.
...
**Usage:**
- Create this at project root as CLAUDE.md, AGENTS.md, or similar
- Customize all placeholder sections to match project
...
## Package-Level Documentation Template

For creating package/module documentation that AI coding agents read to understand sub-level conventions.
...
**Usage:**
- Create this as README.md in package/module directories
- Focus on what's different from project-level conventions
