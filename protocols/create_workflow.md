...
Workflows exist on a spectrum from deterministic to adaptive:

### Deterministic Workflows

Steps are known in advance and execute in fixed order. No branching or conditional logic needed.

**Characteristics:**
- All steps are predictable
- No uncertainty to resolve mid-workflow
...
Steps may surface uncertainty, complexity, or blockers that require investigation or scope adjustment.

**Characteristics:**
- Some steps may reveal unknowns
...
- **Rollback behavior** — Should partial work be cleaned up on failure?
...
- [ ] Steps identified: [list primitives in order]
